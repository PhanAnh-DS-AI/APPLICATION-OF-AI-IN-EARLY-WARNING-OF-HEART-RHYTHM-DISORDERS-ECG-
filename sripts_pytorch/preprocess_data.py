...
class ECGDataProcessor:
    def __init__(self, data_path: str, look_back: int, train_split: int, val_split: int, device: str):
        """Initialize data processor with parameters"""
        self.data_path = data_path
        self.look_back = look_back
        self.train_split = train_split  
        self.val_split = val_split  
        self.device = device  # Thêm device để chuyển dữ liệu sang GPU/CPU
        self.data = None
...
if __name__ == "__main__":
    ...
    processor = ECGDataProcessor(data_path, look_back=look_back, train_split=train_split, val_split=val_split, device=device)
